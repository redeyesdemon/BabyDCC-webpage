...
function removeUser(id){
	if(confirm("Esta seguro que desa remover al jugador "+id+"?")){
		...
		for(var aux = id+1; aux <= cant; aux++){
			...
			document.getElementById("j"+aux+"_nom").setAttribute("name", "j"+prev+"_nom");
			...
			document.getElementById("j"+aux+"_nom").setAttribute("id", "j"+prev+"_nom");
...
function checkForm(form){
	...
	if(document.getElementById("tea_nam").value == ""){
		alert("El nombre del equipo no puede ser vacío");
		return false;
	}
	if(document.getElementById("tea_c1").value == ""){
		alert("El color primario del equipo no puede ser vacío");
		return false;
	}
	if(document.getElementById("tea_c2").value == ""){
		alert("El color secundario del equipo no puede ser vacío");
		return false;
	}
